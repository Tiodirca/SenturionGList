                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          List<String>
                                                                              chaveVazia =
                                                                              [];
                                                                          dados[Constantes.parametroEdicaoCadCamposBanco] =
                                                                              chaveVazia;
                                                                          dados[Constantes.parametroEdicaoCadNomeTabela] =
                                                                              widget.nomeTabela;
                                                                          dados[Constantes.parametroEdicaoCadIdItem] =
                                                                              idItem;
                                                                          Navigator.pushReplacementNamed(
                                                                              context,
                                                                              Constantes.rotaTelaEdicao,
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          if (itensBanco.length ==
                                                                              1) {
                                                                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(Textos.erroExclusaoItemListagem)));
                                                                          } else {
                                                                            exibirConfirmacaoExclusao(idItem,
                                                                                dataItem);
                                                                          }
                                                                        },
                                                                        child: const Icon(
